...
fn native_output_smoke_payload(media_url: &str, step: u64) -> NativeOutputPayload {
    ...
    NativeOutputPayload {
        ...
        params: NativeOutputParams {
            ...
            palette_cycle_mode: Some("blend".to_string()),
            palette_cycle_amount: Some(0.65),
            palette_cycle_ranges: Some(vec![palette::CycleRange { start: 7, end: 10, rate: 1.4, direction: 1, offset: 0.0 }]),
            palette_cycle_transport: Some(palette::Transport { anchor_ms: palette::now_ms(), position: phase, from_rate: 1.0, to_rate: 1.0, duration_ms: 0.0 }),
