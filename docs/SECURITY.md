...
- Public macOS release CI fails closed when Apple Developer ID signing or
  notarization is incomplete. Public 0.9.11 macOS artifacts are signed,
  notarized, stapled, and Gatekeeper-validated; Windows 0.9.11 artifacts are
  unsigned previews.
...
- Windows 0.9.11 artifacts are unsigned previews and may trigger Unknown
